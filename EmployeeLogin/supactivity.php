<?php
session_start();
//redirect employee to loginpage if not logged in
...
<img src = 'whitelogo.png' class="img-responsive"/>
    ...
    <form action = "supervisordashboard.php">  
...
<table class="table table-bordered">
   ...
   <th>BankName</th>     
    ...
    <?php
           ...
           //fetch the details of the client who has been verified by supervisor
            $query10 = "SELECT * FROM FIXEDDEPOSITDB WHERE ID IN (SELECT CustomerID FROM supdashboard);";
